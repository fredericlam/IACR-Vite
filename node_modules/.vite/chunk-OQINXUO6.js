...
// node_modules/@carbon/icons-vue/es/utils-6832c513.js
...
var getSvgAttrs = function getSvgAttrs2(title, svgAttrs, componentAttrs) {
  return getAttributes(_objectSpread22(_objectSpread22({}, svgAttrs), {}, {
    preserveAspectRatio: "xMidYMid meet",
    xmlns: "http://www.w3.org/2000/svg",
    title
  }, componentAttrs));
};
var getVue2SvgAttrs = function getVue2SvgAttrs2(title, svgAttrs, data, listeners) {
  var result = {
    attrs: getSvgAttrs(title, svgAttrs, data.attrs),
    on: listeners,
    style: _objectSpread22(_objectSpread22({}, data.staticStyle), data.style)
  };
...
var createSVGComponent = function createSVGComponent2(name, svgAttrs, svgContent) {
  return _objectSpread22({
    ...
    setup: function setup(_ref, _ref2) {
      ...
      var componentAttrs = _ref2.attrs, slots = _ref2.slots;
      return function() {
        return h("svg", getSvgAttrs(title, svgAttrs, componentAttrs), [].concat(_toConsumableArray(title ? [h("title", title)] : []), _toConsumableArray(svgContent.map(function(_ref3) {
          var elem = _ref3.elem, attrs = _ref3.attrs;
          return h(elem, attrs);
    ...
    render: function render(createElement, _ref4) {
      var title = _ref4.props.title, children = _ref4.children, data = _ref4.data, listeners = _ref4.listeners;
      return createElement("svg", getVue2SvgAttrs(title, svgAttrs, data, listeners), [].concat(_toConsumableArray(title ? [createElement("title", null, title)] : []), _toConsumableArray(svgContent.map(function(_ref5) {
        var elem = _ref5.elem, attrs = _ref5.attrs;
...
//# sourceMappingURL=chunk-OQINXUO6.js.map
